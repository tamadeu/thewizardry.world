    ...
    <div class="header-actions">
      ...
      <div class="header-brand">
        ...
        <div class="logo">
          ...
          <img class="icon-logo-vikinger small" src="/img/logo/logo_ww.png" />
          <!-- /ICON LOGO VIKINGER -->
        </div>
        <!-- /LOGO -->

        <!-- HEADER BRAND TEXT -->
        <h1 class="header-brand-text">The Wizardry World</h1>
        <!-- /HEADER BRAND TEXT -->
      </div>
      <!-- /HEADER BRAND -->
    </div>
        ...
        <div class="action-list-item-wrap">
          ...
          <div class="dropdown-box header-dropdown">
            ...
            <div class="dropdown-box-list" data-simplebar>
              ...
              <!-- DROPDOWN BOX LIST ITEM -->
              <div class="dropdown-box-list-item  {{ ($notification->status == "Unread") ? 'unread' : '' }}">
                <!-- USER STATUS -->
                <div class="user-status notification">
                  <!-- USER STATUS AVATAR -->
            ...
            <!-- DROPDOWN BOX BUTTON -->
            <a class="dropdown-box-button secondary" href="{{ route('profile.notifications') }}">View all Notifications</a>
            <!-- /DROPDOWN BOX BUTTON -->
          </div>
          <!-- /DROPDOWN BOX -->
        </div>
        ...
        <div class="dropdown-navigation header-settings-dropdown">
          ...
          <div class="dropdown-navigation-header">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><span class="bold">Hi {{ $user->firstName }}!</span></p>
              <!-- /USER STATUS TITLE -->
