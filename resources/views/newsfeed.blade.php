              ...
              <div class="form-row">
                ...
                <div class="form-item">
                  ...
                  <div class="form-textarea">
                    <textarea id="quick-post-text" name="quick-post-text" placeholder="Hi {{ $user->firstName }}! Share your post here..."></textarea>
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="tag-list">
                ...
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="/feed">StrikerGO</a>
                <!-- /TAG ITEM -->

                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="/feed">Outlaws</a>
                <!-- /TAG ITEM -->
        ...
        <div class="widget-box no-padding">
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="/feed">Photos</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="/feed">StreamCon</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="/feed">StarGirl</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
