                    ...
                    <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                        <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                            <div class="quick-icon border border-light">
                                <img class="icon" src="/admin/images/flags/english-sq.png" alt="">
                            </div>
                        </a>
                            ...
                            <ul class="language-list">
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="/admin/images/flags/english.png" alt="" class="language-flag">
                                        <span class="language-name">English</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="/admin/images/flags/spanish.png" alt="" class="language-flag">
                                        <span class="language-name">Español</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="/admin/images/flags/french.png" alt="" class="language-flag">
                                        <span class="language-name">Français</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="/admin/images/flags/turkey.png" alt="" class="language-flag">
                            ...
                            <div class="dropdown-body">
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/lms/message.html">
                                            <div class="chat-media user-avatar">
                                                <img src="/admin/images/avatar/b-sm.jpg" alt="">
                                            </div>
                                            <div class="chat-info">
                                                <div class="chat-from">
                                        ...
                                        <a class="chat-link" href="html/lms/message.html">
                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                <div class="user-avatar">
                                                    <img src="/admin/images/avatar/c-sm.jpg" alt="">
                                                </div>
                                                <div class="user-avatar">
                                                    <span>AB</span>
                                                </div>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/lms/message.html">
                                            <div class="chat-media user-avatar">
                                                <img src="/admin/images/avatar/a-sm.jpg" alt="">
                                                <span class="status dot dot-lg dot-success"></span>
                                            </div>
                                            <div class="chat-info">
                                                <div class="chat-from">
